...
const SignUp = () => {
  return (
    <div className="grid grid-cols-3 h-screen relative">
      <div
        style={{
          backgroundImage: `url('https://images.pexels.com/photos/2272940/pexels-photo-2272940.jpeg?auto=compress&cs=tinysrgb&w=1260&h=750&dpr=1')`,
          backgroundSize: "cover",
        }}
        className="col-span-2 relative"
      >
        <div
          className="absolute inset-0 bg-[#E36276] opacity-50"
          style={{ zIndex: 1 }}
        ></div>
      </div>

      <div className="col-span-1  grid place-items-center h-screen">
        <div className="w-4/5  ">
          <h1 className="text-3xl my-5 font-bold text-center">Sign Up</h1>
          <form class=" ">
            ...
            <button
              type="submit"
              class="bg-gradient-to-r bg-[#E36276] text-white font-bold py-2 px-4 rounded-md mt-4 w-full  transition ease-in-out duration-150"
            >
              Submit
            </button>
          </form>
